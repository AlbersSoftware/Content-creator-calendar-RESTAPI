...
//keep a collection of content pieices in memory
    ...
    @PostConstruct
    private void init(){
        Content content = new Content(1, "First Blog Post","my first blog post",Status.IDEA, Type.ARTICLE, LocalDateTime.now(),null,"");
        contentList.add(content);
